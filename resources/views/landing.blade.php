                        ...
                        <div class="flex-1">
                            ...
                            @if($restaurant->city)
                                <div class="flex items-center gap-1 text-xs text-gray-500 mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-primary" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M10 2a6 6 0 00-6 6c0 4.627 6 10 6 10s6-5.373 6-10a6 6 0 00-6-6zm0 8a2 2 0 110-4 2 2 0 010 4z" clip-rule="evenodd" />
                                    </svg>
                            ...
                            @isset($restaurant->distance)
                                ...
                                <div class="flex items-center gap-1 text-xs text-gray-500 mt-1">
                                    @if($dist > 2)
                                        <img
                                            src="{{ asset('img/distanciaCoche.svg') }}"
                                            alt="En coche"
                                            class="w-5 h-5"/>
                                    @else
                                        <img
