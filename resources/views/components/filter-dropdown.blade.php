...
<div x-data="landingFilters()" class="max-w-7xl mx-auto px-4 mt-4">
    <div class="flex justify-end items-center space-x-2">
        ...
        {{-- Botón “Cerca de mí” (geolocaliza y aplica automáticamente) --}}
        <button
            type="button"
            @click="geolocate()"
        ...
        <a href="{{ route('landing') }}"
           class="inline-flex items-center px-3 py-1.5 border border-gray-200 bg-white text-sm text-primary rounded-md shadow-sm hover:bg-gray-100 transition">
            Limpiar filtros
        </a>
    </div>
